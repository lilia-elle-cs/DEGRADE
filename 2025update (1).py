...
import math
import gseapy as gp
#importing everything from original code

#initialisation, but ignored atherosclerosis stuff 
kegg = {} 
...
#REMEMBER TO REMOVE ANY OF THESE THAT ARENT USED

#opening tab seperated csvs + building a dictionary. This is for the pathway files so will be pathway: [genes]
...
#opening comma seperated csvs + building a dictionary. This is for the RNAseq files so will be gene: [logFC, p]
...
#opening tab seperated csvs + building a dictionary. This is for the RNAseq files so will be gene: [logFC, p]
...
for x in ChEA:
  if x == 'MYC':
    for y in ChEA[x]:
      myctargets.append(y)
  elif x == 'USF1' or x == 'FCHL' or x == 'UEF'  or x == 'MLTF'  or x == 'MLTFI' or x == 'HYPLIP1' or x == 'BHLHB11'  or x == 'FCHL1' or x == 'USF': #all aliasaes of usf1
    for y in ChEA[x]:
...
#change 0 to whatever logFC thresold you want
...
#removed heatmap code as not used
